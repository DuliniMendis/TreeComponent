...
var TreeComponent = function (_Component) {
  _inherits(TreeComponent, _Component);
  ...
  _createClass(TreeComponent, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: this.props.classNames.wrapperName },
        this.props.data.map(function (item, i) {
          return _react2.default.createElement(_TreeItem2.default, _extends({ key: "tvs" + i
          }, item, {
